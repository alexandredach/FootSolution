...
{
    internal class ParisSaintGermain : Teams, ITeamManager
    {

        public ParisSaintGermain()
        {
            PlayersOnField.Add(new Player(1, "Kylian", "MBAPPE", Cities.Paris, Status.On_Field));
            PlayersOnField.Add(new Player(3, "Ousmane", "DEMBELE", Cities.Paris, Status.On_Field));
            PlayersOnField.Add(new Player(4, "Marco", "ASENSIO", Cities.Paris, Status.On_Field));
            PlayersOnField.Add(new Player(7, "Randal", "KOLO MUANI", Cities.Paris, Status.On_Field));
            PlayersOnField.Add(new Player(8, "Bryan", "BARCOLA", Cities.Paris, Status.On_Field));
            PlayersOnField.Add(new Player(12, "Achraf", "HAKIMI", Cities.Paris, Status.On_Field));
            PlayersOnField.Add(new Player(13, "Mauricio", "UGARTE", Cities.Paris, Status.On_Field));
            PlayersOnField.Add(new Player(15, "Lucas", "HERNANDEZ", Cities.Paris, Status.On_Field));
            PlayersOnField.Add(new Player(17, "Thimotée", "PEMBELE", Cities.Paris, Status.On_Field));
            PlayersOnField.Add(new Player(18, "Arnau", "TENAS", Cities.Paris, Status.On_Field));

            PlayersSubstitute.Add(new Player(2, "Keylor", "NAVAS", Cities.Paris, Status.Substitute));
            PlayersSubstitute.Add(new Player(5, "Sergio", "RICO", Cities.Paris, Status.Substitute));
            PlayersSubstitute.Add(new Player(6, "Nordi", "MUKIELE", Cities.Paris, Status.Substitute));
            PlayersSubstitute.Add(new Player(9, "Carlos", "SOLER", Cities.Paris, Status.Substitute));
            PlayersSubstitute.Add(new Player(10, "Thilo", "KEHRER", Cities.Paris, Status.Substitute));
        }
